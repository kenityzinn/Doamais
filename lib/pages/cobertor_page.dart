...
class CobertorPage extends StatelessWidget {
  const CobertorPage({super.key});

  @override
  Widget build(BuildContext context) {
    //acessar produtos da classe SHOP
    final products = context.watch<Shop>().shop.where((element) => element.name == "cobertor").toList();
